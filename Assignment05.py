...
#   Kaeli Deng,11/06/2025, Created Script
# ------------------------------------------------------------------------------------------ #
import _io
import json #Import json module for this program
...
#Use try-except statement to avoid errors
try:
